...
export const DialogHeader:FC<React.ComponentPropsWithoutRef<"div">> = ({className, ...props}) => (
    <div className={cn(
...
export const DialogFooter:FC<React.ComponentPropsWithoutRef<"div">> = ({className, ...props}) => (
    <div className={cn(
