...
-- AddForeignKey
ALTER TABLE "UserScholarships" ADD CONSTRAINT "UserScholarships_scholarshipId_fkey" FOREIGN KEY ("scholarshipId") REFERENCES "Scholarship"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
